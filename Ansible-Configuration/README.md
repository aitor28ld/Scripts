...
- Comprueba si el usuario que lo ejecuta, tiene configuradas las claves SSH, sino las crea.
...
Una vez que el script ha terminado de ejecutarse, ejecuta el comando que se te indica para terminar de configurar la conectividad con el host.
